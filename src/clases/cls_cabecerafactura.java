 ...
 * @author davba
 */
public class cls_cabecerafactura {
    ...
    public cls_cabecerafactura(){
        
        
    }

    public cls_cabecerafactura(int num_fac, String fec_fac, String ced_cli, double sub_fac, double des_fac, double iva_fac, double tot_fac) {
    ...
    public String guardar(){    //int num_fac, String fec_fac, String ced_cli, double sub_fac, double des_fac, double iva_fac, double tot_fac)
         return obj_conx.ejecutar("INSERT INTO cabecera_factura (num_fac, fec_fac,ced_cli, sub_fac, des_fac) VALUES ("+getNum_fac()+",'"+getFec_fac()+"','"+getCed_cli()+"',"+getSub_fac()+","+getDes_fac()+","+getIva_fac()+","+getTot_fac()+")");
