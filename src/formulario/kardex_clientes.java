...
public class kardex_clientes extends javax.swing.JDialog {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        if (tabla_clientes.getSelectedRow() >= 0) {
            setCed_cli(tabla_clientes.getValueAt(tabla_clientes.getSelectedRow(), 0).toString());
            setNom_cli(tabla_clientes.getValueAt(tabla_clientes.getSelectedRow(), 1).toString());
            doClose(RET_OK);
        } else {
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
      ...
      if (cb_combo.getSelectedItem().toString().equals("*")) {
           cnx.CargarTabla("Select cod_equi as CODIGO,nom_equ as NOMBRE,mar_equi as MARCA,mod_equi as MODELO,cant_equi as CANTIDAD,col_equi as COLOR,cos_uni_equi as COSTOUNITARIO,est_equ as ESTADO From equipos", tabla_clientes);

        }
      if (cb_combo.getSelectedItem().toString().equals("Codigo")) {
          cnx.CargarTabla("Select cod_equi as CODIGO,nom_equ as NOMBRE,mar_equi as MARCA,mod_equi as MODELO,cant_equi as CANTIDAD,col_equi as COLOR,cos_uni_equi as COSTOUNITARIO,est_equ as ESTADO From equipos Where (cod_equi=" + txt_buscar.getText() + ")", tabla_clientes);

      }
      if (cb_combo.getSelectedItem().toString().equals("Nombre")) {
           cnx.CargarTabla("Select cod_equi as CODIGO,nom_equ as NOMBRE,mar_equi as MARCA,mod_equi as MODELO,cant_equi as CANTIDAD,col_equi as COLOR,cos_uni_equi as COSTOUNITARIO,est_equ as ESTADO From equipos Where (nom_equ='" + txt_buscar.getText() + "')", tabla_clientes);
